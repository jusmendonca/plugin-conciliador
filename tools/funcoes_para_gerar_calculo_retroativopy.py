...
def calcular_valor_rural(csv_path, data_inicial_parcelas, data_final_parcelas):
    """
...
def calcular_valor_devido_BPC(csv_path, data_inicial_parcelas, data_final_parcelas):
    """
    Calcula o valor devido com base nas parcelas de um arquivo CSV, sem incluir o cálculo da gratificação natalina.
    ...
    # Soma total dos valores devidos (sem gratificação natalina)
    valor_total_devido = (
        rm_atual_proporcional_inicial.sum() +
        soma_rm_atual_intermediario +
        rm_atual_proporcional_final.sum()
...
csv_path = 'C:/Users/igor.gomes/Documents/GitHub/automacao/plugin-conciliador/tools/BPC-LOAS.csv'
data_inicial_parcelas = '09/03/2021'
data_final_parcelas = '07/03/2024'
caminho_arquivo_html = 'C:/Users/igor.gomes/Documents/GitHub/automacao/plugin-conciliador/tools/BPC-LOAS.html'
resumo_calculo, df_calculo = calcular_valor_devido_BPC(csv_path, data_inicial_parcelas, data_final_parcelas)
